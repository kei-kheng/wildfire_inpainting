...
def main(steps, visualise, model="none", log_dir=None):
    ...
    data_index = 5000  # Change this to change environment
    ...
    if visualise:
        ...
        for step in range(steps):
            pygame.display.set_caption(
                "DL Augmented Single-Agent Exploration t={}".format(step)
            )
            ...
            mse_score, psnr_score, ssim_score = accuracy(
                env.reshape(784), prediction.reshape(784)
            )
            ...
            for i in range(len(env_square)):
                for j in range(len(env_square[0])):
                    ...
                    pygame.draw.rect(
                        screen, (colour, colour, colour), (i * 10, j * 10 + 30, 10, 10)
                    )
            ...
            for i in range(len(p_square)):
                for j in range(len(p_square[0])):
                    ...
                    pygame.draw.rect(
                        screen,
                        (modifier * colour, colour, modifier * colour),
                        (i * 10 + 840, j * 10 + 30, 10, 10),
                    )

            # Draw the agent
            pygame.draw.rect(
                screen, (255, 0, 0), (pos[1] * 10 + 280, pos[0] * 10 + 30, 10, 10)
            )
            # add eyes to agent
            pygame.draw.circle(
                screen, (255, 255, 255), (pos[1] * 10 + 280 + 7, pos[0] * 10 + 32), 2
            )
            pygame.draw.circle(
                screen, (255, 255, 255), (pos[1] * 10 + 280 + 2, pos[0] * 10 + 32), 2
            )
            pygame.draw.circle(
                screen, (0, 0, 0), (pos[1] * 10 + 280 + 7, pos[0] * 10 + 32), 1
            )
            pygame.draw.circle(
                screen, (0, 0, 0), (pos[1] * 10 + 280 + 2, pos[0] * 10 + 32), 1
            )
